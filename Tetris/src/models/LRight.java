...
/**
 * RightLShape.java:
 * Creates a right-oriented L-shape tetronimo.
 *
 ...
 * @see java.awt.Point
 */
public class LRight extends Tetronimo
{
    /**
    ...
    /**
     * Rotates the Right L-shape tetronimo
     */
    @Override
    public void rotate()
    {
        ...
        {
            case 1: // Default orientation (Vertical L-shape pointing right)
                super.r1.setLocation(Tetronimo.SIZE, 0);
                super.r2.setLocation(Tetronimo.SIZE, Tetronimo.SIZE);
                super.r3.setLocation(Tetronimo.SIZE, Tetronimo.SIZE * 2);
                super.r4.setLocation(0, Tetronimo.SIZE * 2);
            ...
            case 3: // Rotated 180° (Horizontal L-shape pointing right)
